...
CREATE INDEX index_trips_from_midtown_to_downtown_hour ON trips_from_midtown_to_downtown_test(hour);
...
4. We shall pick a suburb Bay Ridge, Brooklyn as the destination this time, and the relevant timeslot is 11AM - 12PM on Sunday.
...
5. We shall pick the friend's place as Crown's Heights NOrth suburb, again in Broklyn. We shall arrive at friend's place at or before 3PM on Sunday.
