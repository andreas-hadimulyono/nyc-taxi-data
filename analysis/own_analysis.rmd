...
All three measures (mean, median, and standard deviation) are very close between rainy days and sunny days, so it seems there is no difference in trip duration between them.
